...
public class routine2 extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		//sunday
		sun.add(getString(R.string.routineTime8));
		...
		//mon
		mon.add(getString(R.string.routineTime8));
		...
		//wed
		wed.add(getString(R.string.routineTime02));
		wed.add(getString(R.string.routineTime03));
		wed.add(getString(R.string.routineTime04));
		//thu
		thu.add(getString(R.string.routineTime02));
		thu.add(getString(R.string.routineTime03));
		//prep child
